...
// use opencv::{mod_prelude::*, imgproc};
...
#[wasm_bindgen]
pub fn bilateral_filter(img: &mut [u8],
                    sigma_spatial: f32,
                    sigma_range: f32,
                    width: u32,
                    height: u32,
...
// #[wasm_bindgen]
// pub fn bilateralFilter(src: &dyn core::ToInputArray, dst: &mut dyn core::ToOutputArray, d: i32, sigma_color: f64, sigma_space: f64, border_type: i32) {
//     imgproc::bilateral_filter(src, dst, d, sigma_color, sigma_space, border_type);
// }
